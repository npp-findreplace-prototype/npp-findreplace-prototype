...
static const ButtonGridSettingOption g_buttonBackModeOptions[] =
{
    { "Opaque", BUTTON_GRID_BUTTON_BACK_OPAQUE },
    { "Transparent simulated", BUTTON_GRID_BUTTON_BACK_TRANSPARENT },
    { NULL, 0 }
};
...
static const ButtonGridSettingOption g_borderStyleOptions[] =
{
    ...
    { "Etched rounded", BUTTON_GRID_BORDER_STYLE_ETCHED_ROUNDED },
    { "Container", BUTTON_GRID_BORDER_STYLE_CONTAINER },
    { "Sunken", BUTTON_GRID_BORDER_STYLE_SUNKEN },
    { "Raised", BUTTON_GRID_BORDER_STYLE_RAISED },
    { "Double", BUTTON_GRID_BORDER_STYLE_DOUBLE },
    { NULL, 0 }
};
...
{
    { "themeName", "Theme", BG_SETTING_THEME, offsetof(ButtonGrid, themeName), 0, 0, NULL },
    { "allowThemeSelection", "Allow theme selector", BG_SETTING_BOOL, offsetof(ButtonGrid, allowThemeSelection), 0, 1, g_boolOptions },
    { "dpiScaleEnabled", "DPI scale grid", BG_SETTING_BOOL, offsetof(ButtonGrid, dpiScaleEnabled), 0, 1, g_boolOptions },

    { "contentAlignment", "Grid alignment", BG_SETTING_ENUM, offsetof(ButtonGrid, contentAlignment), 0, 0, g_alignmentOptions },
    { "contentAlignX", "Grid align X", BG_SETTING_INT, offsetof(ButtonGrid, contentAlignX), -2000, 2000, NULL },
    { "contentAlignY", "Grid align Y", BG_SETTING_INT, offsetof(ButtonGrid, contentAlignY), -2000, 2000, NULL },
    { "contentAlignPercentX", "Grid align percent X", BG_SETTING_INT, offsetof(ButtonGrid, contentAlignPercentX), 0, 100, NULL },
    { "contentAlignPercentY", "Grid align percent Y", BG_SETTING_INT, offsetof(ButtonGrid, contentAlignPercentY), 0, 100, NULL },
    ...
    { "showBorderTitle", "Show border title", BG_SETTING_BOOL, offsetof(ButtonGrid, showBorderTitle), 0, 1, g_boolOptions },
    ...
    { "borderTitleHeight", "Border title height", BG_SETTING_INT, offsetof(ButtonGrid, borderTitleHeight), 0, 120, NULL },
    { "borderTitlePadding", "Border title padding", BG_SETTING_INT, offsetof(ButtonGrid, borderTitlePadding), 0, 80, NULL },
    { "borderTitleFontSize", "Border title font size", BG_SETTING_INT, offsetof(ButtonGrid, borderTitleFontSize), 0, 96, NULL },
    { "borderTitleTransparent", "Border title transparent", BG_SETTING_BOOL, offsetof(ButtonGrid, borderTitleTransparent), 0, 1, g_boolOptions },
    { "borderTitleAutoBackColor", "Border title auto back", BG_SETTING_BOOL, offsetof(ButtonGrid, borderTitleAutoBackColor), 0, 1, g_boolOptions },
    { "borderStyle", "Border style", BG_SETTING_ENUM, offsetof(ButtonGrid, borderStyle), 0, 0, g_borderStyleOptions },
    { "borderThickness", "Border thickness", BG_SETTING_INT, offsetof(ButtonGrid, borderThickness), 1, 12, NULL },
    { "borderCornerRadius", "Border corner radius", BG_SETTING_INT, offsetof(ButtonGrid, borderCornerRadius), 0, 80, NULL },
